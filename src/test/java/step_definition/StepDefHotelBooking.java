...
public class StepDefHotelBooking {
	...
	//driver = new FirefoxDriver();
		System.setProperty("webdriver.chrome.driver","C:\\Users\\Sagar Jawale\\Desktop\\ChromDriver\\chromedriver.exe");
...
public void user_is_on_hotel_booking_page() throws Throwable {
	...
	//driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
	//objhbpg = new HotelBookingPageFactory(driver);
	driver.get("file:///C://Users//Sagar%20Jawale//Desktop//hotel%20booking%20Maven//hotelBooking//hotelbooking.html");
}
...
public void navigate_to_welcome_page() throws Throwable {
	driver.navigate().to("file:///C:/Users/Sagar%20Jawale/Desktop/hotel%20booking%20Maven/hotelBooking/success.html");
